...
def get_top_edges(output_dir, top_n=3):
...
def print_metrics(output_dir):
    ...
    print("\n--- SUMMARY ---")
    steps = parse_summary(f"{output_dir}/summary.xml")
    if steps:
...
if __name__ == "__main__":
    directory = sys.argv[1] if len(sys.argv) > 1 else "output/krakow_sim_19843701#4"
